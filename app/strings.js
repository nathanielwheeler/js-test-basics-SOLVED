...
function letterAtPosition(str, position, length = position + 1) {
...
function capitalizer(str, position, length = position + 1) {
  return str.substring(position, length).toUpperCase();
}